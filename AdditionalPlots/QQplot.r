##DESCRIPTION
#Plot a minor-allele stratified quantile-quantile plot
#Script written by Lars Fritsche

##INSTRUCTIONS
#No need to copy the script to your home directory
#Below is some sample code
#Rscript --vanilla /home/bdsi2019/genomics/data/mr/sample_code/QQplot.r --input MySummaryStats-4Manhattan.txt --prefix MyOutPutPrefix --maf EAF --pvalue p.value --maintitle="My Plot Title"
#In this example the effect/risk allele frequency column is called EAF in MySummaryStats-4Manhattan.txt, and the p-value column is p.value
#This will take awhile, so it would be good to run in screen
